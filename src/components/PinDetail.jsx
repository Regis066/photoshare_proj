...
const PinDetail = ({user}) => {
  ...
  return (
    ...
    {pinDetail.comments && pinDetail.comments.map((comment)=>{
      return(
        <div className='flex gap-2 mt-5 items-center bg-wjite rounded-lg' key={comment.comment}>
        <img 
    ...
    <button
    type='button'
    className='bg-red-500 text-whit rounded-full px-6 py-2 font-semibold outline-none'
    onClick={addComment}
    >
